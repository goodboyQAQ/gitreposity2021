...
public class SimpleDebugger {
    ...
    //java -cp ".;%JAVA_HOME%\lib\tools.jar" jdi_demo.SimpleDebugger
    public static void main(String[] args) throws Exception {
        ...
        mainArg.setValue("jdi_demo.HelloWorld");
        ...
        classPrepareRequest.addClassFilter("jdi_demo.HelloWorld");
    ...
    private static void execute(Event event) throws Exception {
        if (event instanceof VMStartEvent) {
            ...
            if (mainClassName.equals("jdi_demo.HelloWorld")) {
            ...
            System.out.println("Reach line 10 of jdi_demo.HelloWorld");
